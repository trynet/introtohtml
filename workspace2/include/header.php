...
function show_header($dirlinks='') {
	...
	echo "<a href='/'><img src='/images/header.png' alt='Joy of Code Introduction to HTML Workspace' /></a>";
	echo "</div>";
	echo "<td style=\"padding-left: 15px; color:black;\" id=\"bookmark_container\" width=\"35%\"></td>\n";
	echo "<td width=\"25%\" style=\"padding-left: 15px; color:black;\">" . $logoutlink . "</td>\n";
